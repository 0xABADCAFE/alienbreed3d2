...
; a0, a1 and param registers are not preserved.
...
; Entry point for unclipped inside half/quarter cases
; d3.l = [ shade level ][ outcode ]
jump_SCUInnerUnclipped:

				movem.l d4-d7/a2-a6,-(sp)

				move.w	d3,d6 ; will switch on this in a moment
				and.w   #$f,d6 ; ensure d6 has only 16 combinations
				...
				move.w  jump_SCU(pc,d6.w*2),d6
				jmp     jump_SCU(pc,d6.w)

jump_SCU:
				dc.w	jump_SCU_nop-jump_SCU ; outcode  0:
				...
				dc.w	jump_SCU_nop-jump_SCU ; outcode  3:
				...
				dc.w	jump_SCU_nop-jump_SCU ; outcode  7:
				...
				dc.w	jump_SCU_nop-jump_SCU ; outcode 11:
				dc.w	jump_SCU_nop-jump_SCU ; outcode 12:
				dc.w	jump_SCU_nop-jump_SCU ; outcode 13:
				dc.w	jump_SCU_nop-jump_SCU ; outcode 14:
				dc.w	jump_SCU_nop-jump_SCU ; outcode 15:
jump_SCU_nop:
				movem.l (sp)+,d4-d7/a2-a6
				rts
